...
<section>
    ...
    <h3>Sign up</h3>
    <input class="border-b border-gray-300 p-2 outline-none block w-full box-border mx-auto" type="text" placeholder="Display name" v-model="displayName">
    ...
    <button class="mybutton text-center" v-if="!auth.isPending">Sign up</button>
